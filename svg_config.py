...
Config = '''
    ...
    <svg
        ...
        Mat.reGetStyleAttVal = function (att) {
            return new RegExp( "(^|.*;)[ ]*"+ att +":([^;]*)(;.*|$)" )
        }

        Mat.setStyle = function (el, att, val) {
            if (typeof(el) == "string")
    ...
    <!-- box_fourth_2 -->
     ...
     <!-- color_fourth -->
        ...
        <path
            onmouseover="   ; Mat.setStyle(this, 'fill', '#61190f')
                    ; Mat.setStyle('path9898-9', 'fill', '#61190f')
                    ; Mat.setStyle('rect9652-2', 'fill', '#61190f')"
            onmouseout="    ; Mat.setStyle(this, 'fill', '#61190f')
                    ; Mat.setStyle('path9898-9', 'fill', '#b3b3b3')
                    ; Mat.setStyle('rect9652-2', 'fill', '#b3b3b3')"
            id="path5048"
    ...
    <!-- color_third -->
        ...
        <path
            onmouseover="   ; Mat.setStyle(this, 'fill', '#669900')
                    ; Mat.setStyle('path9898-5', 'fill', '#669900')
                    ; Mat.setStyle('rect9652-0', 'fill', '#669900')"
            onmouseout="    ; Mat.setStyle(this, 'fill', '#669900')
                    ; Mat.setStyle('path9898-5', 'fill', '#b3b3b3')
                    ; Mat.setStyle('rect9652-0', 'fill', '#b3b3b3')"
            id="path5051"
    ...
    <!-- color_second -->
        ...
        <path
            onmouseover="   ; Mat.setStyle(this, 'fill', '#99cc00')
                    ; Mat.setStyle('path9898-6', 'fill', '#99cc00')
                    ; Mat.setStyle('rect9652-6', 'fill', '#99cc00')"
            onmouseout="    ; Mat.setStyle(this, 'fill', '#99cc00')
                    ; Mat.setStyle('path9898-6', 'fill', '#b3b3b3')
                    ; Mat.setStyle('rect9652-6', 'fill', '#b3b3b3')"
            id="path5059"
    ...
    <!-- color_first -->
        ...
        <ellipse
            onmouseover="   ; Mat.setStyle(this, 'fill', '#d2ed1a')
                    ; Mat.setStyle('rect9652', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5075', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5077', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5079', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path9898', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5083', 'fill', '#d2ed1a')"
            onmouseout="    ; Mat.setStyle(this, 'fill', '#d2ed1a')
                    ; Mat.setStyle('rect9652', 'fill', '#b3b3b3')
                    ; Mat.setStyle('path5075', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5077', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path9898', 'fill', '#b3b3b3')
                    ; Mat.setStyle('path5079', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5083', 'fill', '#d2ed1a')"
            ry="10.921379"
            rx="10.626206"
        ...
        <ellipse
            onmouseover="   ; Mat.setStyle(this, 'fill', '#d2ed1a')
                    ...
                    ; Mat.setStyle('path9898', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5083', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5081', 'fill', '#d2ed1a')"
            onmouseout="    ; Mat.setStyle(this, 'fill', '#d2ed1a')
                    ; Mat.setStyle('rect9652', 'fill', '#b3b3b3')
                    ; Mat.setStyle('path5075', 'fill', '#d2ed1a')
                    ; Mat.setStyle('path5077', 'fill', '#d2ed1a')
